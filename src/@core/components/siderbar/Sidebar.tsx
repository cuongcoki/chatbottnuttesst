...
import logo from "../../../../public/image/logo/logo_tnut.png";
import logo2 from "../../../../public/image/logo/logo_tnut.png";
                          ...
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              `block px-4 py-2 rounded-lg transition-all duration-200 capitalize text-sm ${
                                isActive
                                  ? "bg-gradient-to-r from-[#A61D37]/10 to-[#2e5288]/10 text-[#A61D37] dark:text-[#A61D37] font-medium border-l-2 border-[#A61D37]"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
        ...
        >
          ...
          >
            <Popover>
              <PopoverTrigger>
                ...
                >
                  <Avatar className="h-12 w-12 border-4 border-white shadow-2xl ring-2 ring-[#A61D37]/20">
                    <AvatarImage src={user?.avatar} alt={user?.full_name} />
                    <AvatarFallback className="bg-gradient-to-br from-[#A61D37] to-[#2e5288] text-white font-bold">
                 ...
                 {!isCollapsed && (
                   <div className="hidden md:flex flex-col items-start leading-tight text-left">
                    ...
                    <span className="text-xs text-[#2e5288] dark:text-gray-400">
                      {getRoleDisplayName()}
                    </span>
                  </div>
                 )}
              ...
              >
                {/* Profile */}
                <div
                  className="p-2 flex items-center rounded-sm text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-[#A61D37]/10 hover:to-[#2e5288]/10 hover:text-[#A61D37] cursor-pointer transition-all"
                ...
                <div
                  className="p-2 flex items-center rounded-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 cursor-pointer transition-all"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute right-6 hover:bg-gradient-to-r hover:from-[#A61D37]/10 hover:to-[#2e5288]/10 hover:text-[#A61D37] rounded-sm transition-all"
